...
<head>
	<style type="text/css">
		...
		.mani-promote .cat .itim{
			padding: 16px 20px;
		}
		.mani-promote .cat .itim:hover{
		...
		<div class="silder">
		  ...
		  {hkcms:position action="position" posid="1"}
                    {volist name="data" id="vo"}               
                        <a href="{$vo.data.url}">
                            <div class="img">
                                <img src="{$vo['data']['thumb']?$vo['data']['thumb']:$config_siteurl.'statics/default/images/dpic.gif'}" alt="{$vo.data.title}" width="150px;" height="150px; "></a>
	...
	<div class="cat-promote clearfix" style="float: left">
		...
		<div class="content">
			<div class="col-2 item">
				...
				<div >
					<a href="{$vo.data.url}">
				<img src="{$vo['data']['thumb']?$vo['data']['thumb']:$config_siteurl.'statics/default/images/dpic.gif'}" alt="{$vo.data.title}" style="width: 150px;height: 150px;">
